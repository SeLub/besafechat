...
1. **Identity** - криптографическая сущность (мастер-ключи)
...
- [ ] Создание новых сущностей (Handle, Team, Channel)
- [ ] Обновление существующих сущностей
- [ ] Создание базовых DTO и интерфейсов

### Фаза 2: Сервисный слой (2 недели)
- [ ] Реализация HandleService
- [ ] Реализация TeamService
- [ ] Реализация ChannelService
- [ ] Обновление ChatService
- [ ] Обновление MessageService
- [ ] Создание совместимого слоя

### Фаза 3: Контроллеры (1 неделя)
- [ ] Реализация новых контроллеров
- [ ] Обновление существующих контроллеров
- [ ] Создание guards и middleware
- [ ] Настройка роутинга
...
- [ ] Swagger документация новых API
